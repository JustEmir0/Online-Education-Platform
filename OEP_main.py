...
Kurslar = [
    ...
    Kurs("Veri Bilimi", "Işık Demir", "499.99 TL", "Veri bilimi ve makine öğrenimi konularında derinlemesine bir kurs."),
    Kurs("Web Geliştirme", "Mahmut Kara", "599.99 TL", "HTML, CSS, JavaScript gibi web geliştirme teknolojilerini öğrenin."),
    Kurs("Yapay Zeka", "Çiçek Şahin", "699.99 TL", "Yapay zeka ve derin öğrenme üzerine kapsamlı bir kurs."),
    Kurs("Mobil Uygulama Geliştirme", "Hasan Yıldız", "399.99 TL", "Android ve iOS için mobil uygulama geliştirme kursu."),
    Kurs("Veritabanı Yönetimi", "Elif Yutkun", "599.99 TL", "SQL ve veritabanı yönetimi konularında temel bir kurs."),
    Kurs("Grafik Tasarım", "Özlem Demir", "429.99 TL", "Adobe Photoshop, Illustrator ve InDesign kursu."),
    Kurs("Blockchain ve Kripto Paralar", "Arslan Kaplan", "399.99 TL", "Blockchain teknolojisi ve kripto para ticareti kursu."),
    Kurs("İşletme Yönetimi", "Cemal Öztürk", "99.99 TL", "Temel işletme yönetimi ve strateji konularında bir kurs."),
    Kurs("Unıty Dersleri Ve Oyun Geliştirme", "Zeynep Kaçıran", "199.99 TL", "Unıty kullanımı ve oyun gelişirmek üzerine bir kurs.")
]
